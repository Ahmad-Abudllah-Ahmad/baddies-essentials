...
export default function NewArrivalsPage() {
  ...
  const products = [
    {
      id: 401,
      name: 'Spring Collection Shift Dress',
      brand: 'Sapphire',
      price: 6500,
  ...
  const categories = ['All New Arrivals', 'Unstitched', 'Ready to Wear', 'Shoes', 'Accessories']
  const brands = ['All Brands', 'Sapphire', 'Generation', 'Beechtree', 'Bareeze']
      ...
      <div className="relative h-[50vh] min-h-[550px] flex items-center justify-center overflow-hidden pt-32">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          <motion.span
            ...
            className="inline-block py-1 px-3 rounded-full bg-violet-600 text-white shadow-lg shadow-violet-600/30 text-sm font-medium tracking-wider uppercase mb-4"
          >
            Fresh Drops
          </motion.span>
          <motion.h1
          ...
          >
            Be the first to wear the latest trends. Straight from the runway to your wardrobe.
          </motion.p>
        </div>
      </div>
            ...
            <div className="glass rounded-2xl p-4 mb-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4 w-full sm:w-auto overflow-x-auto pb-2 sm:pb-0">
                ...
                <div className="text-sm font-semibold text-slate-500 whitespace-nowrap">
                  Showing <span className="text-slate-900">{products.length} products</span>
                </div>
              </div>
