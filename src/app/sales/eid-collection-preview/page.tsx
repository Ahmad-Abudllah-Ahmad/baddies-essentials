...
export default function EidCollectionPreviewPage() {
  ...
  const handleSubscribe = () => {
    ...
    toast.success('You will be notified when the Eid Collection launches!')
  }
  ...
  const featuredBrands = [
    ...
    { name: 'Lama', logo: 'https://images.unsplash.com/photo-1564257577-4f0e2c8b9e3e?w=100&h=100&fit=crop&auto=format' }
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100">
      ...
      <div className="relative overflow-hidden">
        ...
        <Image
          src="https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1200&h=600&fit=crop&auto=format"
          alt="Eid Collection Preview"
          width={1200}
          height={600}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <div className="flex items-center justify-center mb-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold">Eid Collection Preview</h1>
            </div>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Exclusive Eid fashion from all your favorite brands
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Exclusive Eid collection with traditional and modern designs</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Be the first to shop the latest Eid fashion trends</p>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Exclusive discounts and bundle deals for subscribers</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-8">Participating Brands</h2>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600">And many more brands joining the celebration!</p>
          </div>
        </div>
      </div>
    </div>
