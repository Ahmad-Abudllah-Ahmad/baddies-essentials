...
export default function MenPage() {
  ...
  const products = allProducts.filter(p => p.id >= 100 && p.id < 200)

  const categories = [
    'All Items', 'Kameez Shalwar', 'Kurtas', 'T-Shirts', 'Jeans', 'Formal Shirts', 'Waistcoats', 'Footwear'
  ]

  const brands = [
    'All Brands', 'J.', 'Charcoal', 'Dynasty', 'Gul Ahmed', 'Sapphire', 'Outfitters'
  ]
    ...
    <div className="min-h-screen bg-slate-50 -mt-28 lg:-mt-32">
      ...
      <div className="relative h-[50vh] min-h-[550px] flex items-center justify-center overflow-hidden pt-32">
        <div className="absolute inset-0 z-0">
          <Image
            src="https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?q=80&w=2670&auto=format&fit=crop"
            alt="Men's Fashion"
            fill
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          >
            Sophisticated styles for the modern gentleman. Elevate your wardrobe with our premium selection.
          </motion.p>
        </div>
      </div>
