...
export default function SignupPage() {
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    role: 'customer' as 'customer' | 'brand'
  })
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(`Account created successfully as ${formData.role}! You can now login.`)
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`p-3 border-2 rounded-lg flex flex-col items-center transition-all ${formData.role === 'customer'
              ...
              >
                ...
                <span className="text-xs text-gray-500">Shop & Browse</span>
              </button>

              <button
                type="button"
                onClick={() => setFormData({ ...formData, role: 'brand' })}
                className={`p-3 border-2 rounded-lg flex flex-col items-center transition-all ${formData.role === 'brand'
                    ? 'border-primary-500 bg-primary-50 text-primary-700'
                    : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
